...
class FamiliesTest < ApplicationSystemTestCase
  ...
  test "should create family" do
    ...
    fill_in "Login", with: @family.login_id
    fill_in "Memo", with: @family.memo
    fill_in "Name", with: @family.name
    fill_in "Password digest", with: @family.password_digest
    fill_in "School", with: @family.school_id
    fill_in "Tel", with: @family.tel
