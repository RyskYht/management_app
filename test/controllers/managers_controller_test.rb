...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference("Manager.count") do
      post managers_url, params: { manager: { login_id: @manager.login_id, password_digest: @manager.password_digest } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { login_id: @manager.login_id, password_digest: @manager.password_digest } }
